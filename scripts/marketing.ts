...
function home(): string {
  ...
  return `<section class="hero wrap">
    <div class="hero-copy"><p class="eyebrow"><span class="short-line"></span> Local-first. Open source. Free.</p>
      ...
      <p class="hero-description">A training planner for running, lifting, and real life. Build with the local engine, or bring your own AI. You decide what to share and what to change.</p>
      <div class="hero-actions"><a class="button" href="./app/">Open your planner ${arrow}</a><a class="text-link" href="#how-it-works">How it works ${arrow}</a></div>
  ...
  <section class="section wrap">
    <div class="section-heading"><p class="eyebrow">A useful tool. Not another service.</p><h2>Less to sign up for.<br>More room to train.</h2><p>Your goal, your routine, and the equipment you actually have. All in one place, without uploading your training to an app server.</p></div>
    <div class="benefit-grid">
      <article><span class="feature-mark" aria-hidden="true">01 /</span><h3>Built in, not locked behind AI</h3><p>Build a starting week, create custom exercises, log sessions, and review your work without a model or API key. The planner is free and MIT licensed.</p></article>
      <article><span class="feature-mark" aria-hidden="true">02 /</span><h3>Your week, with context</h3><p>Running, lifting, available days, and fixed commitments belong in the same plan. The engine explains its placements; you can move or skip a session when life changes.</p></article>
      <article><span class="feature-mark" aria-hidden="true">03 /</span><h3>Ready when the gym isn&rsquo;t online</h3><p>After the first successful load and offline setup, reopen the app in the same browser to plan and log every set. Your training records live locally, not in our cloud.</p></article>
    </div>
  </section>
  ...
  <section class="section harness-section wrap">
    <div class="section-heading"><p class="eyebrow">An optional AI harness</p><h2>AI suggests.<br><span class="serif">You stay in charge.</span></h2><p>Bring your own chat or your own API key. The harness gives AI your chosen context and brings its suggestions back for review, not automatic control.</p></div>
    <div class="harness-grid"><div class="harness-option"><h3>Copy &rarr; discuss &rarr; review</h3><p>Preview a brief built from your setup or weekly review. Copy it to your own AI chat, discuss it, then bring the reply back to the app. Review the proposed exercises and explanation before approving.</p></div><div class="harness-option"><h3>Or connect your own API key</h3><p>Explicitly send the same brief to a compatible provider from your browser. Connection details and your API key stay in the open tab&rsquo;s memory only, not in your saved training or backups.</p></div></div>
  ...
  <section class="section wrap continuity-section">
    <div class="section-heading"><p class="eyebrow">A plan that keeps its history</p><h2>Next week starts<br>with what happened.</h2><p>Log actual sets, reps, weights, duration, and effort. Review completed, partial, skipped, and unlogged work without pretending they are the same thing.</p></div>
  ...
  <section class="ownership-section wrap">
    <div><p class="eyebrow">Local by default. Shared by choice.</p><h2>Your records,<br><span class="serif">not our database.</span></h2><a class="text-link" href="./privacy/">Privacy, in plain language ${arrow}</a></div>
    <div><p>The app stores your plans, library, and training logs in IndexedDB in this browser. No login, app backend, hidden telemetry, or automatic training uploads. Export local backups to keep a copy or move to another device.</p><p>Local-first does not mean nothing ever leaves your device. The static host handles ordinary request metadata. If you choose AI, the brief you share goes to your chosen chat or provider under its policies.</p><p class="fine-print">Browser data can be cleared or lost. Keep a backup somewhere you trust. Remote AI needs a connection; the planner works offline once its offline copy is ready.</p></div>
  </section>
